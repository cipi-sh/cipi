...
task('cipi:audit:rollback', function () { cipi_deploy_audit('rollback'); });
after('deploy:symlink', 'cipi:audit:published');
after('deploy:failed', 'cipi:audit:failed');
after('rollback', 'cipi:audit:rollback');
